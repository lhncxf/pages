...
- [代码片段记录整理](#代码片段记录整理)
  - [正则表达式收集](#正则表达式收集)
    - [校验链接](#校验链接)
    - [校验字符串大小写、字母](#校验字符串大小写字母)
    - [校验邮箱](#校验邮箱)
    - [校验手机号](#校验手机号)
    - [校验金额格式](#校验金额格式)
  - [防抖函数](#防抖函数)
  - [el-form校验失败滚动到对应位置](#el-form校验失败滚动到对应位置)
  - [封装localstorage、sessionstorage](#封装localstoragesessionstorage)
  - [原生JS实现滚动条滚动到某个指定位置](#原生js实现滚动条滚动到某个指定位置)
  - [封装axios](#封装axios)
  - [时间转换为字符串](#时间转换为字符串)
  - [时间间隔字符串显示](#时间间隔字符串显示)
  - [获取url里的参数](#获取url里的参数)
  - [原生JavaScript操作元素class](#原生javascript操作元素class)
  - [深克隆](#深克隆)
  - [随机字符串](#随机字符串)
  - [自适应移动端不同设备宽度](#自适应移动端不同设备宽度)
  - [颜色rgb转16进制](#颜色rgb转16进制)
  - [vue-cli 发布静态资源到阿里云oss存储，静态资源全走cdn](#vue-cli-发布静态资源到阿里云oss存储静态资源全走cdn)
  - [vue-cli 设置图片小于某一大小，编译为base64编码，减少页面图片请求](#vue-cli-设置图片小于某一大小编译为base64编码减少页面图片请求)
## 正则表达式收集
